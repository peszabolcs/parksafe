...
export default function ProfileScreen() {
  ...
  const [activeTab, setActiveTab] = useState<"activity" | "reviews">(
    "activity"
  );
        ...
        <View style={styles.profileSection}>
          <View style={styles.avatarContainer}>
            <Feather
              name="user"
              size={32}
              color={colorScheme === "dark" ? "#777" : "#8E8E93"}
            />
          </View>
            ...
            <>
              ...
              >
                <Feather
                  ...
                  style={styles.buttonIcon}
                />
                <Text style={[styles.logoutButtonText, { color: "#1976D2" }]}>
                  Bejelentkezés
                </Text>
              </Pressable>
              <Pressable
              ...
              >
                <Feather
                  ...
                  style={styles.buttonIcon}
                />
                <Text style={[styles.logoutButtonText, { color: "#388E3C" }]}>
                  Regisztráció
                </Text>
              </Pressable>
            </>
...
const createThemedStyles = (themeColors: any, colorScheme: "light" | "dark") =>
  StyleSheet.create({
    container: {
      flex: 1,
    ...
    logoutButton: {
      ...
      borderRadius: 8,
      borderColor:
        colorScheme === "dark" ? "rgba(255, 59, 48, 0.3)" : "#FFE5E5",
      backgroundColor: colorScheme === "dark" ? "#1C1C1E" : "#FFFFFF",
    },
    buttonIcon: {
      marginRight: 8,
